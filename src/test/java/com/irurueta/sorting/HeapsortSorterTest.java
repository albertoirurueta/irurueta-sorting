...
class HeapsortSorterTest {
    ...
    void testSortWithComparator() {
        for (int t = 0; t < TIMES; t++) {
            ...
            final var sorter = new HeapsortSorter<Date>();
            sorter.sort(array, fromIndex, toIndex, Comparator.naturalOrder());
    ...
    void testSortDoubles() {
        for (int t = 0; t < TIMES; t++) {
            ...
            final var sorter = new HeapsortSorter<Double>();
    ...
    void testSortFloats() {
        for (int t = 0; t < TIMES; t++) {
            ...
            final var sorter = new HeapsortSorter<Float>();
            sorter.sort(array, fromIndex, toIndex);
    ...
    void testSortInts() {
        for (int t = 0; t < TIMES; t++) {
            ...
            final var sorter = new HeapsortSorter<Integer>();
            sorter.sort(array, fromIndex, toIndex);
    ...
    void testSortLongs() {
        for (int t = 0; t < TIMES; t++) {
            ...
            final var sorter = new HeapsortSorter<Long>();
            sorter.sort(array, fromIndex, toIndex);
    ...
    @Test
    void testGetMethod() {
        final var sorter = new HeapsortSorter<>();
