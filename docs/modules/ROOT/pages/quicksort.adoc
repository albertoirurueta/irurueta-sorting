...
:keywords: QuicksortSorter, Quicksort algorithm, partition-exchange sort, median-of-three pivot, SystemSorter, java.util.Arrays sort, Numerical Recipes
...
image::quicksort-partition.svg[Quicksort partitioning the array 5 3 8 1 9 2 7 around a median-of-three pivot,760]
...
|`QuicksortSorter`
|https://github.com/albertoirurueta/irurueta-sorting/blob/master/src/main/java/com/irurueta/sorting/QuicksortSorter.java[GitHub]
|https://albertoirurueta.github.io/irurueta-sorting/mvn-site/apidocs/com/irurueta/sorting/QuicksortSorter.html[Javadoc]

|`SystemSorter`
|https://github.com/albertoirurueta/irurueta-sorting/blob/master/src/main/java/com/irurueta/sorting/SystemSorter.java[GitHub]
|https://albertoirurueta.github.io/irurueta-sorting/mvn-site/apidocs/com/irurueta/sorting/SystemSorter.html[Javadoc]
