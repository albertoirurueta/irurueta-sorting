...
:keywords: Sorter.select, Sorter.median, k-th smallest element, order statistics, ComparatorAndAverager, ComparableAndAverageable, linear-time selection, Numerical Recipes
...
|`ComparatorAndAverager`
|https://github.com/albertoirurueta/irurueta-sorting/blob/master/src/main/java/com/irurueta/sorting/ComparatorAndAverager.java[GitHub]
|https://albertoirurueta.github.io/irurueta-sorting/mvn-site/apidocs/com/irurueta/sorting/ComparatorAndAverager.html[Javadoc]

|`ComparableAndAverageable`
|https://github.com/albertoirurueta/irurueta-sorting/blob/master/src/main/java/com/irurueta/sorting/ComparableAndAverageable.java[GitHub]
|https://albertoirurueta.github.io/irurueta-sorting/mvn-site/apidocs/com/irurueta/sorting/ComparableAndAverageable.html[Javadoc]
|===
