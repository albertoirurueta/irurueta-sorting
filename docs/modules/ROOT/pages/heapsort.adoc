...
than or equal to its two "supervisees", all the way down the hierarchy. The diagram below
...
elements that are only related laterally (for example, stem:[a_3] and stem:[a_4]).
